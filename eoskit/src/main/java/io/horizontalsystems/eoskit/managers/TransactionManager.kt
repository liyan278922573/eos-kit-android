...
class TransactionManager(
    ...
    private fun process2(name: String, token: String, publicKey: String): String {
        ...
        val reqJson = "{\"creator\":\"liyan1234511\",\"name\":\""+name+"\",\"owner\":{\"threshold\":1,\"keys\": [{ \"key\": \"BACC5hXB9NnfyThvHE9V6mNS2fPSjsPifpT8qRgr8hPc36uL4woEXV\",\"weight\":1}],\"accounts\":[],\"waits\":[]},\"active\":{\"threshold\":1,\"keys\":[{\"key\":\"BACC5hXB9NnfyThvHE9V6mNS2fPSjsPifpT8qRgr8hPc36uL4woEXV\",\"weight\":1}],\"accounts\":[],\"waits\":[]},\"vid\":\""+vid+"\"}"
